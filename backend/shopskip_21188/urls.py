"""shopskip_21188 URL Configuration
...
admin.site.site_header = "Shopskip"
admin.site.site_title = "Shopskip Admin Portal"
admin.site.index_title = "Shopskip Admin"

# swagger
api_info = openapi.Info(
    title="Shopskip API",
    default_version="v1",
    description="API documentation for Shopskip App",
)
